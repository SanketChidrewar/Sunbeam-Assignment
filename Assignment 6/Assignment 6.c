...
//Implement a circular queue of students. Each student information includes roll, name, std,
	...
	for (int i = 0; i < 5; ++i)
		{
			if(stud[i].flag==1)
			{
				printf("\nstud[%d] is",i );
				//printf("\nFlag = %d",stud[i].flag );
				printf("\nSTUDENT roll no :%d",stud[i].roll_no);
				printf("\nSTUDENT Name is :%s",stud[i].name);
				printf("\nSTUDENT STD is  :%c",stud[i].std);
				printf("\nSTUDENT Physics Marks :%d",stud[i].physics.marks);
				printf("\nSTUDENT chemistry Marks :%d",stud[i].chemistry.marks);
				printf("\nSTUDENT mathematics Marks :%d",stud[i].mathematics.marks);
				printf("\nSTUDENT history Marks :%d",stud[i].history.marks);
				printf("\nSTUDENT geography Marks :%d",stud[i].geography.marks);
				printf("\nSTUDENT marathi Marks :%d\n",stud[i].marathi.marks);
			}
		}
}
